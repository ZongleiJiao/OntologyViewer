...
AddOntologyAnnotation::AddOntologyAnnotation(JavaMarker* dummy)
  : org::semanticweb::owlapi::model::OWLOntologyChange(dummy)
{
  updateAllVariables(wrapperIntern);
}

AddOntologyAnnotation::AddOntologyAnnotation(jobject obj)
  : org::semanticweb::owlapi::model::OWLOntologyChange(obj)
{
  updateAllVariables(wrapperIntern);
}

AddOntologyAnnotation::AddOntologyAnnotation(org::semanticweb::owlapi::model::OWLOntology* arg1, org::semanticweb::owlapi::model::OWLAnnotation* arg2)
  : org::semanticweb::owlapi::model::OWLOntologyChange(wrapperIntern)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
...
void AddOntologyAnnotation::updateAllVariables(JavaMarker* dummy)
{
  jclass cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
}

void AddOntologyAnnotation::updateAllNonFinalVariables(JavaMarker* dummy)
{
  jclass cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
}

bool AddOntologyAnnotation::equals(java::lang::Object* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
const char* AddOntologyAnnotation::toString()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
int AddOntologyAnnotation::hashCode()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
org::semanticweb::owlapi::model::OWLAnnotation* AddOntologyAnnotation::getAnnotation()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
void AddOntologyAnnotation::accept(org::semanticweb::owlapi::model::OWLOntologyChangeVisitor* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
java::lang::Object* AddOntologyAnnotation::accept(org::semanticweb::owlapi::model::OWLOntologyChangeVisitorEx* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
bool AddOntologyAnnotation::isAxiomChange()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
org::semanticweb::owlapi::model::OWLAxiom* AddOntologyAnnotation::getAxiom()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
...
bool AddOntologyAnnotation::isImportChange()
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddOntologyAnnotation");
  handleJavaException(wrapperIntern);
