...
AddAxiom::AddAxiom(JavaMarker* dummy)
  : org::semanticweb::owlapi::model::OWLAxiomChange(dummy)
{
  updateAllVariables(wrapperIntern);
}

AddAxiom::AddAxiom(jobject obj)
  : org::semanticweb::owlapi::model::OWLAxiomChange(obj)
{
  updateAllVariables(wrapperIntern);
}

AddAxiom::AddAxiom(org::semanticweb::owlapi::model::OWLOntology* arg1, org::semanticweb::owlapi::model::OWLAxiom* arg2)
  : org::semanticweb::owlapi::model::OWLAxiomChange(wrapperIntern)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
...
void AddAxiom::updateAllVariables(JavaMarker* dummy)
{
  jclass cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
  handleJavaException(wrapperIntern);
}

void AddAxiom::updateAllNonFinalVariables(JavaMarker* dummy)
{
  jclass cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
  handleJavaException(wrapperIntern);
}

bool AddAxiom::equals(java::lang::Object* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
  handleJavaException(wrapperIntern);
...
void AddAxiom::accept(org::semanticweb::owlapi::model::OWLOntologyChangeVisitor* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
  handleJavaException(wrapperIntern);
...
java::lang::Object* AddAxiom::accept(org::semanticweb::owlapi::model::OWLOntologyChangeVisitorEx* arg1)
{
  jclass    cls = javaEnv->FindClass("org/semanticweb/owlapi/model/AddAxiom");
  handleJavaException(wrapperIntern);
